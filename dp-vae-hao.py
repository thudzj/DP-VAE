...
def encoder(input_tensor):
    mid_features = (pt.wrap(input_tensor).
            ...
            fully_connected(500, name='encoder_fc2', activation_fn=tf.nn.relu).
            fully_connected(2000, name='encoder_fc3', activation_fn=tf.nn.relu))
...
if __name__ == "__main__":
    ...
    learning_step = optimizer.minimize(overall_loss, var_list = encoder_trainables + decoder_trainables + [qeta_mu], global_step = global_step)
